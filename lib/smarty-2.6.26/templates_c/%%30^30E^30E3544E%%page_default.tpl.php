<?php /* Smarty version 2.6.26, created on 2010-05-28 09:47:43
         compiled from /home/francois/dev/the_blog/module/page/tpl/page_default.tpl */ ?>
<div id="content">
    <div id="content_block">
        ...
        <ol>
            ...
            <li>
                Added <code>
                            <?php echo '$(document).ready(function () {<br/ >
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$().popeye(); <br/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});
                            '; ?>
            ...
            <li>
                ...
                Moved the <?php echo '$(document).ready();'; ?>
 section to the bottom of the page as per best practices.
                <br/><br/>
            </li>
            <li>
                Onto example two :
